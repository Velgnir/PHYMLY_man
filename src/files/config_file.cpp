...
void ConfigFileOpt::init_opt_description() {
    opt_conf.add_options()
            ...
            ("field-properties.up_func_arg", po::value<size_t>(&up_func_arg),"up_func_arg")
            ...
            ("field-properties.left_func_arg", po::value<size_t>(&left_func_arg),"left_func_arg")
            ...
            ("field-properties.right_func_arg", po::value<size_t>(&right_func_arg),"right_func_arg")
            ...
            ("field-properties.bottom_func_arg", po::value<size_t>(&bottom_func_arg),"bottom_func_arg")
            ...
            ("main.temperature_limit", po::value<double>(&temperature_limit), "temperature_limit");
}
