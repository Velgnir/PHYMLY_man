...
public:
    ...
    [[nodiscard]] const size_t &get_left_func_arg() const { return left_func_arg; };

    [[nodiscard]] const size_t &get_right_func_arg() const { return right_func_arg; };

    [[nodiscard]] const size_t &get_up_func_arg() const { return up_func_arg; };

    [[nodiscard]] const size_t &get_bottom_func_arg() const { return bottom_func_arg; };
